...
const MagicForm = ({ fields, onSubmit, title = "Form", button = "Submit", layout = "grid", initialValues, loading, card = true, modal = false, onClose }: MagicFormProps) => {
    ...
    const renderField = ({ name, label, type, options, optionPlaceHolder = "Select" }: MagicFormFieldProps) => (
